...
- コミット: 6b014927f267906714b6367fbcfeb61da77f2f1d
- nuxt.js, vue どちらかわからないが、ts やバージョン周りのエラー多い

## src/配下へのリファクタ

- `srcDir: src/`にしているがうまくいかなかったので、1 つ戻す
- ホワイトボードに事実を落書きして整理してみる
- 改善せずだったので愚直に事実を copilot に投げて、pages/を自動で作成するスクリプトの path 問題だとわかり修正
- `eeefb74f4b0bb0f8f1305328ea233413984c2cbf`
